...
[CreateAssetMenu(fileName = "RidgedPerlinNoiseGenerator", menuName = "SO/NoiseGenerator/RidgedPerlinNoiseGenerator")]
public class RidgedPerlinNoiseGenerator : NoiseGenerator
{
    [SerializeField]
    private int seed = 0;
    [SerializeField]
    ...
    public override float[] GetHeightNoiseValues(Vector3[] points)
    {
        ...
        for (int octaveNum = 0; octaveNum < octaves; octaveNum++)
        {
            ...
            for (int i = 0; i < points.Length; i++)
            {
                ...
                noiseValues[i] += (1 - Mathf.Abs(perlinValue)) * amplitude / 2f;
            }
